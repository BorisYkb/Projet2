...
<head>
    ...
    <title>Recherche de planteurs</title>
            ...
            <table>
                ...
                <tbody>
                    <?php
                        ...
                        WHERE ID_USER LIKE '%" . mysqli_real_escape_string($conn, $search) . "%' 
                        OR NOM_USER LIKE '%" . mysqli_real_escape_string($conn, $search) . "%' 
                        OR NUM_USER LIKE '%" . mysqli_real_escape_string($conn, $search) . "%' 
                        OR MAIL_USER LIKE '%" . mysqli_real_escape_string($conn, $search) . "%'";
