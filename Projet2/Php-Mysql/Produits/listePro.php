...
<body>
    ...
    <div class="contenue">
        ...
        <div class="tableproduction">
            ...
            <div class="addproduction1"><a href="enregistrerPro.php" class="addproduction"><div><i class='bx bx-store-alt'></i></div><h4>Ajouter</h4></a></div>
            ...
            <table>
                ...
                <tfoot>
                        <tr>
                            <td colspan="6">
                                <caption>
                                    <h3>Liste des <span>productions</span></h3>
                                </caption>
