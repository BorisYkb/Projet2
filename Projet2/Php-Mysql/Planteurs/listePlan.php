...
<body>
    ...
    <div class="contenue">
        ...
        <div class="tablemember">
            ...
            <div class="addmember1"><a href="../Planteurs/enregistrerPlan.php" class="addmember"><div><i class='bx bx-user-plus'></i></div><h4>Ajouter</h4></a></div>
            ...
            <table>
                ...
                <tbody>
                    <?php
                        ...
                        $req = "SELECT * FROM USER WHERE NIVEAU = 2";
                    ...
                    <tr>
                        ...
                        <td>
                                          ...
                                          <a class='production' href='../Produits/listeProPlan.php?iduser=$row[ID_USER]'>Production</a>
                                        </td>
                    </tr>
                        ";
                           }
                ...
                <tfoot>
                        <tr>
                            <td colspan="6">
                                <caption>
                                    <h3>Liste des <span>planteurs</span></h3>
                                </caption>
